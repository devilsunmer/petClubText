	...
	public ReadMemberUI() {
		...
		allMemberButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				readOut.setText(memberServiceImpl.allMember().toString());
			}
		});
		...
		allFreeMemberButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				freeMemberOut.setText(new CustFreeMemberServiceImpl().allFreeMember().toString());
			}
		});
		...
		imagePhoto.setBounds(0, 0, 531, 327);
