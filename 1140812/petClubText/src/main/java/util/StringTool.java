...
import util.forPrint.ReportDefinition;
...
public class StringTool {
	...
	public static void useTitleNameForReport(String reportName, String fileName, String sheetName) {
		ReportDefinition report = ReportDefinition.getReportmap().get(reportName);
	    ...
	    excelCreate.create(fileName, sheetName, report.getTitle());
	    
	    // 寫入資料
	    report.getDataWriter().accept(excelCreate);
	}
