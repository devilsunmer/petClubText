		...
		creatMember.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(custMemberUsername==null) {
					...
					/**可能要修改username if條件*/
					if(StringTool.isUserPass(custMemberUsername)&&custMemberUsername!=memberService.viewMemberName(custMemberUsername).getCustUsername()) 
					{
				...
				if(custMemberPassword==null) {
					...
					if(StringTool.isUserPass(custMemberPassword)) 
					{
