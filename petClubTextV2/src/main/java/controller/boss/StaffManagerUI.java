	...
	public StaffManagerUI() {
		...
		food.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				String selectedFood = food.getSelectedItem() != null ? food.getSelectedItem().toString() : "";
				switch (selectedFood) {
				case "":
		...
		enterIncome.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				viewStaffIcomeArea.setText("");
				viewStaffIcomeArea.setText(new StaffIncomeServiceImpl().viewStaffIncome());
